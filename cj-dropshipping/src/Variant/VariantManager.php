...
class VariantManager
{
    ...
    {
        $url = getenv('CJ_API_BASE_URL') . '/product/variant/query';
    ...
    {
        $url = getenv('CJ_API_BASE_URL') . '/product/variant/queryByVid';
        $accessToken = $this->authenticator->getAccessToken();
    ...
    {
        $url = getenv('CJ_API_BASE_URL') . '/product/comments';
        $accessToken = $this->authenticator->getAccessToken();
    ...
    {
        $url = getenv('CJ_API_BASE_URL') . '/product/productComments';
        $accessToken = $this->authenticator->getAccessToken();
